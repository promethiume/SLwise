...
def process_data(redic):
    ...
    isme_data = pd.read_csv(
        '/home/testenv/SyntheticLethal/new/A375_process/is_me_or_not_cutoff_0.05_symmetric_matrix.csv'
    )
    low_data = pd.read_csv(
        '/home/testenv/SyntheticLethal/new/A375_process/low_expr_low_geneEffect_symmetric_matrix.csv'
    )
    par_data = pd.read_csv(
        '/home/testenv/SyntheticLethal/new/A375_process/paralogs_symmetric_matrix.csv'
    )
    fold_data = pd.read_csv(
        '/home/testenv/SyntheticLethal/mymodel/A375_process/A375fold.csv'
    )
    # combined_score_data=pd.read_csv('/home/testenv/git_code/xiugai/new/HT29_process/is_me_or_not_cutoff_0.05_symmetric_matrix.csv')
    # low_data=pd.read_csv('/home/testenv/git_code/xiugai/new/HT29_process/low_expr_low_geneEffect_symmetric_matrix.csv')
    # par_data=pd.read_csv('/home/testenv/git_code/xiugai/new/HT29_process/paralogs_symmetric_matrix.csv')
    isme_data = remove_invalid(isme_data, redic)
    low_data = remove_invalid(low_data, redic)
    par_data = remove_invalid(par_data, redic)
    fold_data = remove_invalid(fold_data, redic)
    # combined_score_data=pd.read_csv('/home/testenv/MGE4SL/update_data/is_me_or_not_p0.05_symmetric_matrix.csv')
    # low_data=pd.read_csv('/home/testenv/MGE4SL/update_data/low_expr_low_geneEffect_symmetric_matrix.csv')
    # par_data=pd.read_csv('/home/testenv/MGE4SL/update_data/paralogs.csv')
    # fold_change=pd.read_csv('/home/testenv/MGE4SL/A549_process/haha.csv')
...
def construct_omic(data, isme_data, low_data, par_data, go_F_data):
    ...
    # low_data=pd.read_csv('/home/testenv/MGE4SL/update_data/paralogs.csv')
...
def main(args, data_path, model, epochs, lr=0.01):
    ...
    if args.out_test:
        df = pd.read_csv(args.HT29_data_path, sep=',')
    ...
    #     print(k_data)
    isme_data, low_data, par_data, fold_data = process_data(redic)

    synlethdb_isme, synlethdb_low, synlethdb_par, fold_data = construct_omic(
        data, isme_data, low_data, par_data, fold_data
    )
